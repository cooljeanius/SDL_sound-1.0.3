...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = playsound.exe
OBJFILES = ..\..\playsound\playsound.obj
RESFILES = 
MAINSOURCE = playsound.bpf
RESDEPEN = $(RESFILES)
LIBFILES = ..\..\..\Borland\lib\SDLmain.lib ..\..\..\Borland\lib\SDL.lib SDL_sound.lib
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
...
INCLUDEPATH = ..\..\playsound;..\..\..\SDL_sound-0.1.5\playsound;..\..;..\..\..\include;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = ..\..\playsound;..\..\..\SDL_sound-0.1.5\playsound;..\..;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;..\..\playsound
PATHASM = .;
PATHPAS = .;
...
PATHOBJ = .;$(LIBPATH)
# ---------------------------------------------------------------------------
CFLAG1 = -Od -H=d:\DEVELO~1\borland\CBUILD~1\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 \
    -b- -k -y -v -vi- -tW -tWM -c -DWIN32
IDLCFLAGS = -I..\..\playsound -I..\..\..\SDL_sound-0.1.5\playsound -I..\.. \
    -I..\..\..\include -I$(BCB)\include -I$(BCB)\include\vcl -src_suffix cpp \
    -D_DEBUG -boa
