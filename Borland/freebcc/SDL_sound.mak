...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = SDL_sound.dll
OBJFILES = ..\..\audio_convert.obj ..\..\extra_rwops.obj ..\..\SDL_sound.obj
RESFILES = 
MAINSOURCE = SDL_sound.bpf
RESDEPEN = $(RESFILES)
LIBFILES = ..\..\..\Borland\lib\SDL.lib
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
...
USERDEFINES = _DEBUG;SDL_SOUND_DLL_EXPORTS
SYSDEFINES = NO_STRICT;_NO_VCL;_RTLDLL;USEPACKAGES
INCLUDEPATH = ..\..;..\..\..\include;$(BCB)\include;$(BCB)\include\vcl
...
CFLAG1 = -WD -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- \
    -tWD -tWM -c
IDLCFLAGS = -I..\.. -I..\..\..\include -I$(BCB)\include -I$(BCB)\include\vcl \
    -src_suffix cpp -D_DEBUG -DSDL_SOUND_DLL_EXPORTS -boa
PFLAGS = -$YD -$W -$O- -$A8 -v -JPHNE -M
RFLAGS = 
AFLAGS = /mx /w2 /zd
LFLAGS = -D"" -aa -Tpd -x -Gn -Gi -v
# ---------------------------------------------------------------------------
ALLOBJ = c0d32.obj $(PACKAGES) $(OBJFILES)
ALLRES = $(RESFILES)
